package com.company.iptvgames.PPTangTest.canvas.gamecanvas;
...
import com.company.iptvgames.PPTangTest.bomb.BombObject;
import com.company.iptvgames.PPTangTest.canvas.gamecanvas.states.*;
import com.company.iptvgames.PPTangTest.resources.ImageRes;
import com.company.iptvgames.framework.utils.*;
...
public class MainGameCanvas extends GameCanvas implements Runnable {
	...
	private void loadImages() {
		ImageRes.getInstance().loadImage("bg1Img", ImageUtil.createImage("/bj1.png"));
	...
	private void drawMap() {
		...
		for(int i = 0; i < NPCsVector.size(); i++){
			((PlayerObject)NPCsVector.elementAt(i)).setPosition(RandomUtil.nextInt(GameConst.GameCanvas.TILES_IN_WIDTH), RandomUtil.nextInt(GameConst.GameCanvas.TILES_IN_HEIGHT));
	...
	public void nextAction(PlayerObject spr){
		...
		int dir = RandomUtil.nextInt(1,5);;//下一步move方向
