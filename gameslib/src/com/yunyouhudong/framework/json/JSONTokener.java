...
public class JSONTokener {
	...
	public Object nextValue() throws JSONException {
		 ...
		 * be a string. Note that the 0-, 0x-, plus, and implied string conventions are non-standard. A JSON parser is free to accept non-JSON forms
		 * as long as it accepts all correct JSON forms.
		 */
